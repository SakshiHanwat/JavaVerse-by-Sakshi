...
- JSF (JavaServer Faces) – UI framework for enterprise apps  
...
- Java EE (Jakarta EE) – Secure and scalable enterprise apps  
- Spring Framework – Comprehensive enterprise Java framework  
...
- JavaFX – Modern GUI for desktop apps  
- Swing – Legacy UI framework for Java  
...
**Technologies & Tools:**
- **Android SDK** – Core toolkit for Android app development  
- **Kotlin (Java Interoperability)** – Modern language fully compatible with Java  
...
- **jMonkeyEngine** – 3D game engine for high-performance gaming  
